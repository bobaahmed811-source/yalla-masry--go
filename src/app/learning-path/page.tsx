    ...
    levels: [
      {
        ...
        modules: [
          { title: 'الوحدة 1: التحيات والتعارف', status: 'completed' },
          { title: 'الوحدة 2: في السوق', status: 'current' },
          { title: 'الوحدة 3: عائلتي وأصدقائي', status: 'locked' },
          { title: 'الوحدة 4: طلب الطعام', status: 'locked' },
        ],
      },
      {
        ...
        modules: [
           { title: 'الوحدة 5: الحديث عن العمل', status: 'locked' },
              ...
              <div className="space-y-4">
                {level.modules.map((module, moduleIndex) => (
                  ...
                  >
                    ...
                    {module.status !== 'locked' && (
                      <Button className="cta-button text-sm px-5 py-2">
                        {module.status === 'current' ? 'ابدأ الدرس' : 'مراجعة'}
                      </Button>
                    )}
                  </div>
                ))}
